...
<script type="text/javascript">
  $(function(){
     //根据id，获取到详情
     InitDetail();
     document.getElementById("difficult1").disabled=true;
     document.getElementById("difficult2").disabled=true;
  })
...
<div class="col-sm-9 col-md-4 col-md-4 main">
    <div id="w0">        
      ...
      <div class="form-group field-testpaper-tid" style='display:flex;'>
          ...
          <div class='radiovv'>
            <input type="radio" id="difficult1" name="difficult" value="0" >是
            <input type="radio" id="difficult2" name="difficult" value="1" style="margin-left:30px;" disable='true'>否
          </div>
          <div class="help-block"></div>
      </div>          
